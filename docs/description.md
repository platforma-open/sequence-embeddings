...
The block picks the model to fit the hardware — ESM-2 650M on a GPU, the lighter ESM-2 150M on CPU to keep runtimes reasonable — and you can force the device (Auto, CPU, or GPU).
